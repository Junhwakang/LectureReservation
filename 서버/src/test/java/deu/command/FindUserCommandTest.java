...
public class FindUserCommandTest {
    ...
    public void testOrderUp() throws Exception {
        System.out.println("\n================================================");
        System.out.println("[Test Start] FindUserCommandTest 시작");
        
        // 1. Arrange
        FindRequest payload = mock(FindRequest.class);
        FindUserCommand instance = new FindUserCommand(payload);
        
        UserService mockService = mock(UserService.class);
        BasicResponse expectedResponse = mock(BasicResponse.class);
        when(expectedResponse.toString()).thenReturn("BasicResponse(FoundUser)");
        when(mockService.find(payload)).thenReturn(expectedResponse);
        
        Field receiverField = FindUserCommand.class.getDeclaredField("receiver");
        ...
        verify(mockService, times(1)).find(payload);
        
        System.out.println(">>> [SUCCESS] FindUserCommandTest 테스트 통과!");
        System.out.println("================================================\n");
    }
}
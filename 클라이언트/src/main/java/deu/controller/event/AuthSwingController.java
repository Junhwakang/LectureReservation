...
public class AuthSwingController {
    ...
    private void handleGithubServer(ActionEvent e){
        openWebpage("https://github.com/Junhwakang/LectureReservation/tree/main");
    }
    ...
    private void handlSetHostPort(ActionEvent e) {
        String host = view.getHostFieldText().trim();
        String portText = view.getPortFieldText().trim();
        ...
        view.getHostFieldComponent().setText(host);
        view.getPortFieldComponent().setText(String.valueOf(port));
    }
    ...
    private AncestorListener createConfigPanelInitListener() {
        return new AncestorListener() {
            ...
            public void ancestorAdded(AncestorEvent event) {
                ...
                Config config = ConfigLoader.getConfig();
                view.getHostFieldComponent().setText(config.server.host);
                view.getPortFieldComponent().setText(String.valueOf(config.server.port));
            }
